...
switch true
    case (C == 2 && CFL == 320)
        logspace_vector_kry = logspace(log10(1e-1), log10(1.2e-12), numpoints);
        tolerance = logspace(-4, -14, 10);
    case (C == 2 && CFL == 20)
        logspace_vector_kry = logspace(log10(0.01), log10(1.25096339910404e-13), numpoints);
        tolerance = logspace(-4, -14, 10);
    case (C == 1/16 && CFL == 40)
        logspace_vector_kry = logspace(log10(0.02), log10(1e-8), numpoints);
        tolerance = logspace(-3, -7.5, 10);
    case (C == 1/16 && CFL == 2.5)
        logspace_vector_kry = logspace(log10(0.009), log10(1e-8), numpoints);
        tolerance = logspace(-3, -7.5, 10);
end
